...
- agent 应先设置 `manifest["report_language"]`，只允许 `zh-CN` 或 `en-US`
- `manifest["report_language"]` 决定最终渲染时使用中文还是英文章节标题与报告框架
- `manifest["report_title"]` 和各个 body 的语言应与 `manifest["report_language"]` 一致
